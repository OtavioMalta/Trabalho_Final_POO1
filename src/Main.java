...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Cliente cliente = new Cliente("Otavio", "1232457", f.parse("31/08/2001") , "rua 1", "Franca", "Sp");
        ...
        supervisor.salvar();
        gerente.salvar();*/
        //contaCorrente.realizarOperacao(Tipo.DEBITO, "dsaa", 222, f.parse("31/08/2001"));
       ...
       // System.out.println(contaPoupanca.lista());
        ...
        //Agencia.realizarEmprestimo(cliente, 7410, 12);
    }
}
